...
export class CookbookRecipeItem extends PureComponent {
  static propTypes = {
  ...
  render() {
    const { _id, title, picture, liked, likedBy, cookbookId } = this.props
...
export default connect(mapStateToProps, { toggleLike })(CookbookRecipeItem)
